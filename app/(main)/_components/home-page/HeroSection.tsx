        ...
        <div className="grid min-h-[600px] grid-cols-1 items-center gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            <div className="animate-fade-in [--animation-delay:600ms]">
              <h1 className="[font-family:'Poppins',Helvetica] text-4xl leading-tight font-semibold tracking-[-0.50px] text-white lg:text-5xl">
                Reliable Airport & City Rides
                <br />
                in California
              </h1>
            </div>
            <p className="animate-fade-in [font-family:'Poppins',Helvetica] text-lg leading-relaxed font-normal tracking-[-0.50px] text-white [--animation-delay:800ms]">
            ...
            <Card className="animate-fade-in rounded-[34px] border-0 bg-[#ffffff33] shadow-[0px_-1.5px_0px_#ffffff66] backdrop-blur-[5px] backdrop-brightness-[100%] [--animation-delay:1000ms] [-webkit-backdrop-filter:blur(5px)_brightness(100%)]">
              <CardContent className="p-8">
                <h2 className="mb-6 [font-family:'Poppins',Helvetica] text-xl leading-[normal] font-semibold tracking-[-0.50px] text-white">
                  Quick Booking
                </h2>
