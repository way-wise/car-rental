...
// Fuel Reports Schema for frontend
export const fuelReportsSchema = object({
  id: string(),
...
export type FuelReports = InferType<typeof fuelReportsSchema>;

// Create fuel reports schema (for fuel reports creation)
export const createFuelReportsSchema = object({
...
export type CreateFuelReportsInput = InferType<typeof createFuelReportsSchema>;
